...
export const projects: Project[] = [
  ...
  // Example:
  {
    ...
    description: `Built a semantic search-powered book recommendation system using Large Language Models...`,
    detailed_description: `Built a semantic search-powered book recommendation system...`,
